...
model configuration.
Deep learning segmentation models of this kind reach Dice scores of $0.83$--$0.94$
on Sirius Red~\cite{liverfibrosis2025, deng2026}, demonstrating that automated CPA
measurement is clinically viable.
...
The full protocol is given in \suppsec{6}.
