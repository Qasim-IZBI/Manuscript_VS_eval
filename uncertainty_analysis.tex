...
independently trained generators $\{G_k\}_{k=1}^{K}$ (schematic in Supplementary
Sec.~5), the ensemble mean is the pixel-wise average
...
(Supplementary Sec.~5) shows that GAN-based uncertainty maps moderately predict
